...
public class   StudentRegistrationFX  extends JFrame implements ActionListener {
...
mainPanel.add(scroll);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater( StudentRegistrationFX ::new);
    }
}